...
class Management:
    def __init__(self, root):
        ...
        self.window.maxsize(width=1350 ,  height=1200)
        self.window.minsize(width=1350 ,  height=1200)		
    ...
    def AddStudent(self):
        self.ClearScreen()
        self.namet1 = Label(self.frame_2, text="Sign UP", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=500,y=10)
        self.name = Label(self.frame_2, text="First Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=200,y=50, width=200)

        self.surname = Label(self.frame_2, text="Last Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=20)
        self.surname_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.surname_entry.place(x=830,y=50, width=200)

        self.course = Label(self.frame_2, text="Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=80)
        self.course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=200,y=110, width=200)

        self.Course_Package = Label(self.frame_2, text="Course Package", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=80)
        self.Course_Package_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Course_Package_entry.place(x=830,y=110, width=200)

        self.date = Label(self.frame_2, text="Date", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.place(x=200,y=170, width=200)

        self.age = Label(self.frame_2, text="Age", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=140)
        self.age_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.age_entry.place(x=830,y=170, width=200)

        self.gender = Label(self.frame_2, text="Gender", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=200)
        self.gender_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.place(x=200,y=230, width=200)

        self.birth = Label(self.frame_2, text="Birthday", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=200)
        self.birth_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birth_entry.place(x=830,y=230, width=200)

        self.contact = Label(self.frame_2, text="Contact No", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=260)
        self.contact_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.contact_entry.place(x=200,y=290, width=200)

        self.email = Label(self.frame_2, text="Email", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=260)
        self.email_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.email_entry.place(x=830,y=290, width=200)

        self.Current_Course = Label(self.frame_2, text="Current Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=320)
        ...
        self.Pending_Course = Label(self.frame_2, text="Pending Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=320)
        self.Pending_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Pending_Course_entry.place(x=830,y=350, width=200)

        self.Completed_Course = Label(self.frame_2, text="Completed Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=380)
        ...
        self.Total_Fees = Label(self.frame_2, text="Total Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=380)
        self.Total_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Total_Fees_entry.place(x=830,y=410, width=200)

        self.Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=200,y=440)
        self.Paid_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Paid_Fees_entry.place(x=200,y=470, width=200)

        self.Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=830,y=440)
        self.Balance_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Balance_Fees_entry.place(x=830,y=470, width=200)

        self.submit_bt_1 = Button(self.frame_2, text='Submit', font=(self.font_1, 12), bd=2, command=self.Submit, cursor="hand2",
        bg=self.color_2,fg=self.color_3).place(x=520,y=520,width=100)


    '''Get the contact number to show a student details'''
    def GetContact_View(self):
        self.ClearScreen()
        self.namet2 = Label(self.frame_2, text="LOG IN PAGE", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=600,y=10)
        self.getInfo = Label(self.frame_2, text="Enter Your First Name", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=550,y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=570, y=220, width=200, height=30)
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 10), bd=2, command=self.CheckContact_View, cursor="hand2", 
        bg=self.color_2,fg=self.color_3).place(x=630,y=280,width=80)
            
    '''To update a student details, get the contact number'''
    def GetContact_Update(self):
        self.ClearScreen()
        self.namet3 = Label(self.frame_2, text="UPDATE PAGE", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=600,y=10)
        self.getInfo = Label(self.frame_2, text="Enter Your First Name", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=550,y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=570, y=220, width=200, height=30)
    ...
    def GetContact_Delete(self):
        self.ClearScreen()
        self.namet4 = Label(self.frame_2, text="DELETE PAGE", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=600,y=10)
        self.getInfo = Label(self.frame_2, text="Enter Your First Name", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=550,y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=570, y=220, width=200, height=30)
    ...
    def date(self):
        self.ClearScreen()
        self.namet5 = Label(self.frame_2, text="USER INFO", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=600,y=10)
        self.getInfo = Label(self.frame_2, text="Enter Date", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=600,y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=570, y=220, width=200, height=30)
    ...
    def CheckContact_View(self):
       if self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your first name",parent=self.window)
       else:
           try:
               connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
               curs = connection.cursor()
               curs.execute("select * from student_register where f_name=%s", self.getInfo_entry.get())
               row=curs.fetchone()
               if row == None:
                   messagebox.showerror("Error!","Name doesn't exists",parent=self.window)
               else:
    ...
    def Checkdate_View(self):
        if self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter the correct date",parent=self.window)
        else:
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                ...
                if row == None:
                    messagebox.showerror("Error!","Date number doesn't exists",parent=self.window)
                else:
                    self.ShowDetails(row)
                    connection.close()
            except Exception as e:
        ...
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    curs.execute("delete from student_register where f_name=%s", self.getInfo_entry.get())
                    connection.commit()
    ...
    def GetUpdateDetails(self, row):
        ...
        self.name = Label(self.frame_2, text="First Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.insert(0, row[0])
        self.name_entry.place(x=100,y=50, width=200,height=22)

        self.surname = Label(self.frame_2, text="Last Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=20)
        self.surname_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.surname_entry.insert(0, row[1])
        self.surname_entry.place(x=530,y=50, width=200,height=22)

        self.course = Label(self.frame_2, text="Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=80)
        self.course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.insert(0, row[2])
        self.course_entry.place(x=100,y=110, width=200,height=22)

        self.Course_Package = Label(self.frame_2, text="Course Package", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=80)
        self.Course_Package_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Course_Package_entry.insert(0, row[3])
        self.Course_Package_entry.place(x=530,y=110, width=200,height=22)

        self.date = Label(self.frame_2, text="Date", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.insert(0, row[4])
        self.date_entry.place(x=100,y=170, width=200,height=22)

        self.age = Label(self.frame_2, text="Age", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=140)
        self.age_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.age_entry.insert(0, row[5])
        self.age_entry.place(x=530,y=170, width=200,height=22)

        self.gender = Label(self.frame_2, text="Gender", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=200)
        self.gender_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.insert(0, row[6])
        self.gender_entry.place(x=100,y=230, width=200,height=22)

        self.birth = Label(self.frame_2, text="Birthday", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=200)
        self.birth_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birth_entry.insert(0, row[7])
        self.birth_entry.place(x=530,y=230, width=200,height=22)

        contact = Label(self.frame_2, text="Contact", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=260)
        ...
        self.email = Label(self.frame_2, text="Email", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=260)
        self.email_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.email_entry.insert(0, row[9])
        self.email_entry.place(x=530,y=290, width=200,height=22)

        self.Current_Course = Label(self.frame_2, text="Current Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=320)
        self.Current_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Current_Course_entry.insert(0, row[10])
        self.Current_Course_entry.place(x=100,y=350, width=200,height=22)

        self.Pending_Course = Label(self.frame_2, text="Pending Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=320)
        self.Pending_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Pending_Course_entry.insert(0, row[11])
        self.Pending_Course_entry.place(x=530,y=350, width=200,height=22)

        self.Completed_Course = Label(self.frame_2, text="Completed Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=380)
        self.Completed_Course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Completed_Course_entry.insert(0, row[12])
        self.Completed_Course_entry.place(x=100,y=410, width=200,height=22)

        self.Total_Fees = Label(self.frame_2, text="Total Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=380)
        self.Total_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Total_Fees_entry.insert(0, row[13])
        self.Total_Fees_entry.place(x=530,y=410, width=200,height=22)

        self.Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=440)
        ...
        self.Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=440)
        self.Balance_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
    ...
    def ShowDetails(self, row):
        self.ClearScreen()
        name = Label(self.frame_2, text="First Name", font=(self.font_2,15,"bold"), bg=self.color_1).place(x=100,y=20)
        name_data = Label(self.frame_2, text=row[0], font=(self.font_1, 10)).place(x=100, y=50)

        surname = Label(self.frame_2, text="Last Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=20)
        surname_data = Label(self.frame_2, text=row[1], font=(self.font_1, 10)).place(x=530, y=50)

        course = Label(self.frame_2, text="Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=80)
        course_data = Label(self.frame_2, text=row[2], font=(self.font_1, 10)).place(x=100, y=110)

        Course_Package = Label(self.frame_2, text="Course Package", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=80)
        Course_Package = Label(self.frame_2, text=row[3], font=(self.font_1, 10)).place(x=530, y=110)

        Date = Label(self.frame_2, text="Date", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=140)
        Date_data = Label(self.frame_2, text=row[4], font=(self.font_1, 10)).place(x=100, y=170)

        age = Label(self.frame_2, text="Age", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=140)
        age_data = Label(self.frame_2, text=row[5], font=(self.font_1, 10)).place(x=530, y=170)

        gender= Label(self.frame_2, text="Gender", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=200)
        gender_data = Label(self.frame_2, text=row[6], font=(self.font_1, 10)).place(x=100, y=230)

        birth = Label(self.frame_2, text="DOB", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=200)
        birth_data = Label(self.frame_2, text=row[7], font=(self.font_1, 10)).place(x=530, y=230)

        contact = Label(self.frame_2, text="Contact No", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=260)
        contact_data = Label(self.frame_2, text=row[8], font=(self.font_1, 10)).place(x=100, y=290)

        email = Label(self.frame_2, text="Email", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=260)
        email_data = Label(self.frame_2, text=row[9], font=(self.font_1, 10)).place(x=530, y=290)

        Current_Course = Label(self.frame_2, text="Current Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=320)
        Current_Course_data= Label(self.frame_2, text=row[10], font=(self.font_1, 10)).place(x=100, y=350)

        Pending_Course = Label(self.frame_2, text="Pending Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=320)
        Pending_Course_data = Label(self.frame_2, text=row[11], font=(self.font_1, 10)).place(x=530, y=350)

        Completed_Course = Label(self.frame_2, text="Completed Course", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=380)
        Completed_Course_data = Label(self.frame_2, text=row[12], font=(self.font_1, 10)).place(x=100, y=410)

        Total_Fees = Label(self.frame_2, text="Total Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=380)
        Total_Fees_data = Label(self.frame_2, text=row[13], font=(self.font_1, 10)).place(x=530, y=410)

        Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=100,y=440)
        Paid_Fees_data = Label(self.frame_2, text=row[14], font=(self.font_1, 10)).place(x=100, y=470)

        Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=530,y=440)
